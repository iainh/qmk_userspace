...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_wrapper(
    ...
    ______________COLEMAK_MOD_DH_L3____________, SCRNSHT,             KC_ESC, ______________COLEMAK_MOD_DH_R3____________,
    MO(_SYMB), LGUI_T(KC_EQUAL), KC_LEFT, KC_RIGHT, NAV_SPC, KC_BSPC, KC_TAB, KC_ENT, KC_UP, KC_DOWN, RGUI_T(KC_QUOTE), MO(_SYMB)
  ),
  ...
  [_TMUX] = LAYOUT_wrapper(
     ...
     __________________TMUX_L3__________________, _______, _______, __________________TMUX_R3__________________,
