...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_COLEMAK] = LAYOUT_wrapper(
  ...
  LGUI_T(KC_BSPC), ______________COLEMAK_MOD_DH_L2____________, SCRNSHT,    KC_ESC, ______________COLEMAK_MOD_DH_R2____________, RGUI_T(KC_QUOTE),
 ...
 [_TMUX] = LAYOUT_wrapper(
   _______, __________________TMUX_L1__________________, _______, _______, __________________TMUX_R1__________________, _______,
   _______, __________________TMUX_L2__________________, _______, _______, __________________TMUX_R2__________________, _______,
   _______, __________________TMUX_L3__________________, _______, _______, __________________TMUX_R3__________________, _______,
                              _______, _______, _______, _______, _______, _______, _______, _______
  )
};
